---
title: Code Blocks
description: Display syntax-highlighted code in your Amaroad slides.
---

## Code Blocks

Amaroad renders code blocks with syntax highlighting. Use standard Markdown fenced code blocks with a language identifier.
...
Amaroad supports a wide range of programming languages, including:
