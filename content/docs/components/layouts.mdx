---
title: Layouts
description: Use built-in layout components to structure your Amaroad slides with columns and centered content.
---

## Layout System

Amaroad slides support layout options through frontmatter slide types and layout components.
