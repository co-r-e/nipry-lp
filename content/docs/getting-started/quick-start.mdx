---
title: Quick Start
description: Create your first slide deck with Amaroad and an AI agent in under 5 minutes.
---

## Create Your First Deck

Once Amaroad is installed and the dev server is running, open your AI coding agent and start prompting.
...
Amaroad works with any agent that can edit files:

<Tabs items="Codex CLI,Gemini CLI,Cursor">

<div>
```bash
$ codex "Create a 5-slide pitch deck in the Amaroad project at decks/my-deck"
```
</div>

<div>
```bash
$ gemini "Create a 5-slide pitch deck in the Amaroad project at decks/my-deck"
```
</div>

<div>
Open the Amaroad project in Cursor and use the AI chat to generate slides.
</div>
...
<Callout type="info">
Amaroad decks are live web pages. Anyone with the URL can view the latest version in real time.
</Callout>
