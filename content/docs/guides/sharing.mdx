...
description: Share your Amaroad slides via Cloudflare Tunnel, export to PDF/PPTX, or present directly.
---

## Sharing Options

Amaroad provides multiple ways to share your slides with others.

### Cloudflare Tunnel

The fastest way to share a live deck. Amaroad includes `cloudflared` as a dependency and has built-in tunnel management. Ask your AI agent:
...
Since Amaroad decks are standard web pages, you can embed them in other sites using an iframe:
