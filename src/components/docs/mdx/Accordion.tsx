...
export function Accordion({ title, defaultOpen = false, children }: AccordionProps): ReactNode {
  return (
    <details className="group my-2 border-b border-[var(--line)]" open={defaultOpen || undefined}>
      ...
      <div className="pb-4 text-sm leading-relaxed text-[var(--ink-soft)]">{children}</div>
    </details>
  );
}
